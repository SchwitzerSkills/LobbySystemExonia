...
public class ItemsUtil {
    ...
    public void setDefaultItems(Player p){
        ...
        p.getInventory().setItem(8, new ItemBuilder(Material.NETHER_STAR).setName("§8» §cLobbys").toItemStack());
        p.getInventory().setItem(9, new ItemBuilder(Material.CHEST).setName("§8» §cEinstellungen").toItemStack());
    }
}
